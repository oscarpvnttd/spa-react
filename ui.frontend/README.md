...
After running `npm start` **in the `ui.frontend` directory**, your app will be automatically opened in your browser (at path http://localhost:3000/content/spa-react/us/en/home.html). If you make edits, the page will reload.
